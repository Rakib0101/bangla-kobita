        ...
        <form method="POST" action="{{ route('poems.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="content_bangla" 
                          ...
                          placeholder="আপনার কবিতা এখানে লিখুন..."
                          required>{{ old('content_bangla') }}</textarea>
...
<script>
    // Enhanced keyboard switcher for poem creation
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function switchKeyboardLayout(method) {
            banglaInputs.forEach(input => {
                ...
                if (input.id === 'title_bangla') {
                    input.placeholder = method === 'avro' ? 'অভ্রে কবিতার শিরোনাম লিখুন...' : 
                                     method === 'unijoy' ? 'ইউনিজয়ে কবিতার শিরোনাম লিখুন...' : 
                                     'ইংরেজিতে কবিতার শিরোনাম লিখুন...';
                } else if (input.id === 'content_bangla') {
                    input.placeholder = method === 'avro' ? 'অভ্রে আপনার কবিতা লিখুন...' : 
                                     method === 'unijoy' ? 'ইউনিজয়ে আপনার কবিতা লিখুন...' : 
                                     'ইংরেজিতে আপনার কবিতা লিখুন...';
                }
            });
        }
