    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600 bangla-text">কবি</p>
            ...
            <div class="space-y-3">
                @foreach($recentUsers as $user)
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-shrink-0">
                            <span class="text-xs {{ $user->is_active ? 'text-green-600' : 'text-red-600' }} bangla-text">
                ...
                @foreach($recentPoems as $poem)
                    <div class="border-l-4 border-blue-500 pl-4">
                        ...
                        <p class="text-xs text-gray-500">
                            {{ $poem->user->name_bangla ?? $poem->user->name }} - {{ $poem->created_at->diffForHumans() }}
                        </p>
                        <span class="text-xs {{ $poem->is_published ? 'text-green-600' : 'text-yellow-600' }} bangla-text">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600">
                                    {{ $poem->user->name_bangla ?? $poem->user->name }} - {{ $poem->created_at->format('d M Y') }}
                                </p>
                            </div>
                            <div class="flex space-x-2">
                                <button class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm bangla-text">
                                    অনুমোদন
                                </button>
                                <button class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-sm bangla-text">
                                    প্রত্যাখ্যান
                                </button>
                            </div>
                        </div>
