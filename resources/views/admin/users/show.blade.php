            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-medium text-gray-900">{{ $user->poems()->where('is_published', true)->count() }}</dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-medium text-gray-900">{{ $user->poems()->where('is_published', false)->count() }}</dd>
                    </dl>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <dl class="space-y-3">
                ...
                <div>
                    ...
                    <dd class="text-sm">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $user->role === 'admin' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800' }} bangla-text">
                ...
                <div>
                    ...
                    <dd class="text-sm">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $user->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} bangla-text">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.poems') }}" class="text-sm text-blue-600 hover:text-blue-800 bangla-text">সব দেখুন</a>
            </div>
            <div class="space-y-3">
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-gray-900 bangla-text">{{ $poem->title_bangla ?? $poem->title }}</p>
                        <p class="text-xs text-gray-500">{{ $poem->created_at->diffForHumans() }}</p>
                        <div class="flex items-center space-x-2 mt-1">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $poem->is_published ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                                {{ $poem->is_published ? 'প্রকাশিত' : 'খসড়া' }}
                            </span>
                            @if($poem->category)
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 bangla-text">
